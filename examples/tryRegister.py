...
def main():
  ...
  #
  delegationID    = "DelegationID_52O8"
  ...
  #
#  if JobIdWrapper.OK != registrationResponse.get<0>():
#    print "FATAL: " + registrationResponse.get<2>()
#    return 1
  
#  creamURL  = registrationResponse.get<1>().getCreamURL()
#  CreamJID  = registrationResponse.get<1>().getCreamJobID()
